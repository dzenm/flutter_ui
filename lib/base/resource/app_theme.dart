...
class AppTheme {
  ...
  Color get disableButton => purple500Foreground; // 禁用的按钮颜色
  Color get selected => purple500; // 选中的颜色
  Color get unselected => purple500Foreground; // 未选中的颜色
  ...
  Color get background => black100; // 普通背景色
  ...
  ///================================ 根据功能命名(局部) ================================
  Color get statusBar => purple700; // statusBar背景颜色
