...
/// 主题颜色的基本实现
abstract class _AppTheme extends _BaseAppTheme with _AppColorMixin {}

/// APP主题的基类，只混入基本的颜色 [_BaseColorMixin]
abstract class _BaseAppTheme with _BaseColorMixin {}

/// 按颜色命名的颜色代码，在此处增加按颜色命名的颜色代码
mixin _BaseColorMixin {
  ///================================ 根据颜色命名 ================================
  /// 由白到黑
...
abstract mixin class _AppColor {
  ///================================ 根据功能命名(整体) ================================
  Color get primaryDark;          // 主要颜色(深色)
  Color get primary;              // 主要颜色
  Color get primaryLight;         // 主要颜色(浅色)
  Color get secondary;            // 次要颜色
  Color get accent;               // 主要颜色的对比颜色
  Color get button;               // 按钮颜色
  Color get disableButton;        // 禁用的按钮颜色
  Color get selected;             // 选中的颜色
  Color get unselected;           // 未选中的颜色
  Color get icon;                 // 图标颜色(浅色white, 深色black900)
  Color get text;                 // 文本颜色(浅色white, 深色black900)
  Color get signText;             // 标记提醒文本颜色
  Color get foreground;           // 普通前景色
  Color get background;           // 普通背景色
  Color get divide;               // 分割线颜色
  Color get hint;                 // 提示颜色
  Color get primaryText;          // 主要文本颜色
  Color get secondaryText;        // 次要文本颜色
  Color get accentText;           // 主要文本颜色的对比文本颜色
  Color get hintText;             // 提示文本颜色

  ///================================ 根据功能命名(局部) ================================
  Color get statusBar;            // statusBar背景颜色
  Color get appbar;               // appbar背景颜色
  Color get bottomBar;            // bottomBar背景颜色
  Color get cardBackgroundDark;   // 卡片背景颜色(深色)
  Color get cardBackground;       // 卡片背景颜色
  Color get cardBackgroundLight;  // 卡片背景颜色(浅色)
  Color get collect;              // 收藏的颜色
  Color get notCollect;           // 未收藏的颜色
  Color get checked;              // 勾选(CheckBox)的颜色
  Color get unchecked;            // 未勾选(CheckBox)的颜色
...
/// APP相关的颜色的实现，@see [_AppTheme] 、 [_AppColor]
mixin _AppColorMixin on _BaseAppTheme implements _AppColor {
  ///================================ 根据功能命名(整体) ================================
  @override Color get primaryDark => purple700;         // 主要颜色(深色)
  @override Color get primary => purple500;             // 主要颜色
  @override Color get primaryLight => purple200;        // 主要颜色(浅色)
  @override Color get secondary => purple500;           // 次要颜色
  @override Color get accent => teal200;                // 主要颜色的对比颜色
  @override Color get button => purple500;              // 按钮颜色
  @override Color get disableButton => purple200;       // 禁用的按钮颜色
  @override Color get selected => purple500;            // 选中的颜色
  @override Color get unselected => purple200;          // 未选中的颜色
  @override Color get icon => white;                    // 图标颜色(浅色white, 深色black900)
  @override Color get text => white;                    // 文本颜色(浅色white, 深色black900)
  @override Color get signText => blue;                 // 标记提醒文本颜色
  @override Color get background => black50;            // 普通背景色
  @override Color get foreground => black50;            // 普通前景色
  @override Color get divide => black300;               // 分割线颜色
  @override Color get hint => black400;                 // 提示颜色
  @override Color get primaryText => black900;          // 主要文本颜色
  @override Color get secondaryText => black600;        // 次要文本颜色
  @override Color get accentText => blue;               // 主要文本颜色的对比文本颜色
  @override Color get hintText => black300;             // 提示文本颜色

  ///================================ 根据功能命名(局部) ================================
  @override Color get statusBar => purple700;           // appbar背景颜色
  @override Color get appbar => purple700;              // appbar背景颜色
  @override Color get bottomBar => white;               // bottomBar背景颜色
  @override Color get cardBackgroundLight => black50;   // 卡片背景颜色(浅色)
  @override Color get cardBackground => black100;       // 卡片背景颜色
  @override Color get cardBackgroundDark => black150;   // 卡片背景颜色(深色)
  @override Color get collect => red;                   // 收藏的颜色
  @override Color get notCollect => black400;           // 未收藏的颜色
  @override Color get checked => blue;                  // 勾选(CheckBox)的颜色
  @override Color get unchecked => black400;            // 未勾选(CheckBox)的颜色
}
