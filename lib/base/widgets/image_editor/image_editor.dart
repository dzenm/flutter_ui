...
class ImageEditorState extends State<ImageEditor> with SignatureBinding, ScreenShotBinding, TextCanvasBinding, RotateCanvasBinding, LittleWidgetBinding, WindowUiBinding {
            ...
            child: ValueListenableBuilder<OperateType>(
              ...
              builder: (ctx, value, child) {
                return Opacity(
                  ...
                  child: Row(
                    mainAxisAlignment: value == OperateType.brush ? MainAxisAlignment.spaceAround : MainAxisAlignment.end,
                    children: [
          ...
          return SizedBox(
            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                  txt,
                  style: TextStyle(color: _panelController.isCurrentOperateType(type) ? const Color(0xFFFA4D32) : const Color(0xFF999999), fontSize: 11),
                )
              ],
            ),
          );
        ...
        RepaintBoundary(
          child: CustomPaint(
              ...
              child: ConstrainedBox(
                constraints: const BoxConstraints(minWidth: double.infinity, minHeight: double.infinity, maxWidth: double.infinity, maxHeight: double.infinity),
              )),
        ));
    //savePath();
    initPainter();
