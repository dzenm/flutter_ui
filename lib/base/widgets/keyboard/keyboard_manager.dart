...
import 'mocks/mock_binary_messenger.dart';
import 'mocks/mock_binding.dart';
...
class CoolKeyboard {
  ...
  static ValueNotifier<double> keyboardHeightNotifier = ValueNotifier(0)..addListener(updateKeyboardHeight);
      ...
      case 'TextInput.setClient':
        ...
        _keyboards.forEach((inputType, keyboardConfig) {
          if (inputType.name == setInputType['name']) {
            ...
            _keyboardController = KeyboardController(client: client!)..addListener(_updateEditingState);
            if (_pageKey != null) {
      ...
      child: IntrinsicHeight(child: Builder(
        builder: (ctx) {
          ...
          return ConstrainedBox(
            constraints: BoxConstraints(minHeight: 0, minWidth: 0, maxHeight: _height, maxWidth: getScreenW(context)),
