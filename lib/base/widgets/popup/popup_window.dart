...
showPopupMoreMenu(BuildContext context, GlobalKey moreKey, List<String> optionList, Function menuItem) {
...
Future<T?> showPopupWindow<T>({
  ...
  Route<T> route = _PopupWindowRoute(
      context: context,
      position: position,
      child: child,
      elevation: elevation,
          ...
          return Material(
            ...
            child: GestureDetector(
              ...
              child: Container(
                ...
                color: isShowBg ? const Color(0x99000000) : Colors.transparent,
                child: CustomSingleChildLayout(
                  delegate: _PopupWindowLayoutDelegate(position!, null, Directionality.of(context)),
                  child: win,
                ),
              ),
            ),
