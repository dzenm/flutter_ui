...
///
/// Created by a0010 on 2025/1/25 11:58
/// 蓝牙工具管理
class BleManager with Logging implements BleConnection {
    ...
    UniversalBle.onScanResult = (BleDevice scanResult) {
      ...
      if (ble == null) {
        if (deviceId.isNotEmpty && scanResult.name != null) {
          ...
          Application().context.read<StudyModel>().updateDevice(deviceId, ble);
        }
      }
    };
    // Perform a scan
