...
/// context.go('/');
extension ARouterHelper on BuildContext {
  ...
  String namedLocation(
    ...
    Map<String, dynamic> queryParameters = const <String, dynamic>{},
      ...
      ARouter.of(this).namedLocation(name,
          pathParameters: pathParameters, queryParameters: queryParameters);

  /// Navigate to a location.
  void go(String location, {Object? extra}) =>
      ARouter.of(this).go(location, extra: extra);
  ...
  Future<T?> push<T extends Object?>(String location, {Object? extra}) =>
      ARouter.of(this).push<T>(location, extra: extra);
  ...
  bool canPop() => ARouter.of(this).canPop();

  /// Pop the top page off the Navigator's page stack by calling
  /// [Navigator.pop].
  void pop<T extends Object?>([T? result]) => ARouter.of(this).pop(result);
  ...
  void pushReplacement(String location, {Object? extra}) =>
      ARouter.of(this).pushReplacement(location, extra: extra);
  ...
  void pushReplacementNamed(
    ...
    Object? extra,
      ...
      ARouter.of(this).pushReplacementNamed(
        name,
        pathParameters: pathParameters,
        queryParameters: queryParameters,
        extra: extra,
  ...
  void replace(String location, {Object? extra}) =>
      ARouter.of(this).replace<Object?>(location, extra: extra);
  ...
  void replaceNamed(
    ...
    Object? extra,
      ...
      ARouter.of(this).replaceNamed<Object?>(name,
          pathParameters: pathParameters,
          queryParameters: queryParameters,
          extra: extra);
}
