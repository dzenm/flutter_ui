...
/// Builds the top-level Navigator for ARouter.
class RouteBuilder {
...
class _CustomNavigatorState extends State<_CustomNavigator> {
  ...
  final ARouterStateRegistry _registry = ARouterStateRegistry();
  ...
  Page<Object?>? _buildPage(BuildContext context, RouteMatchBase match) {
    if (match is RouteMatch) {
      ...
      return _buildPageForARoute(context, match);
    }
  ...
  Page<Object?>? _buildPageForARoute(BuildContext context, RouteMatch match) {
    final ARouterPageBuilder? pageBuilder = match.route.pageBuilder;
    ...
    final ARouterWidgetBuilder? builder = match.route.builder;
  ...
  void _cacheAppType(BuildContext context) {
    ...
    if (_pageBuilderForAppType == null) {
      ...
      if (elem != null && isMaterialApp(elem)) {
        ...
        _errorBuilderForAppType =
            (BuildContext c, ARouterState s) => CupertinoErrorScreen(s.error);
      } else {
        ...
        _errorBuilderForAppType =
            (BuildContext c, ARouterState s) => ErrorScreen(s.error);
      }
    }
  ...
  ARouterState _buildErrorState(RouteMatchList matchList) {
  ...
  Page<void> _buildErrorPage(BuildContext context, RouteMatchList matchList) {
    final ARouterState state = _buildErrorState(matchList);
    ...
    _cacheAppType(context);
    final ARouterWidgetBuilder? errorBuilder = widget.errorBuilder;
