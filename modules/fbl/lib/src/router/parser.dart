...
/// The function signature of [ARouteInformationParser.onParserException].
///
...
class ARouteInformationParser extends RouteInformationParser<RouteMatchList> {
  /// Creates a [ARouteInformationParser].
  ...
  Future<RouteMatchList> parseRouteInformationWithDependencies(
    ...
    if (initialMatches.isError) {
      configuration.log('No initial matches: ${routeInformation.uri.path}');
    }
  ...
  RouteInformation? restoreRouteInformation(RouteMatchList configuration) {
    ...
    String? location;
    if (ARouter.optionURLReflectsImperativeAPIs &&
